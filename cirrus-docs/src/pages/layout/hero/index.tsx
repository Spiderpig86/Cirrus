        ...
        <main className="page-layout">
            <div>
                ...
                <section className="padtop" id="basic">
                    ...
                    <div className="content">
                        <CodeBlock code={`<div class="hero bg-indigo-600">
    <div class="hero-body">
        <div class="content">
            ...
            <h5 class="subtitle text-gray-300">And I am the subtitle.</h5></div>
                ...
                <section className="padtop" id="fullscreen">
                    ...
                    <div className="content">
                        <CodeBlock code={`<div class="hero fullscreen bg-yellow-200">
    <div class="hero-body">
        <div class="mx-auto">
            ...
            <h3 class="subtitle text-gray-600">I am tall!</h3></div>
                ...
                <section className="padtop" id="parallax">
                    ...
                    <div className="content">
                        <CodeBlock code={`<div id="splash-img" class="hero fullscreen hero-img parallax-img">
    <div class="hero-body">
