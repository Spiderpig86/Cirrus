                ...
                <section className="padtop" id="frames">
                    <div className="content">
                        ...
                        <p>
                            ...
                            <Link to="../components/cards" className="u u-LR">
                                cards
                            </Link>
                ...
                <section className="padtop" id="basics">
                    <div className="content">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <CodeBlock code={`<div class="frame">
    ...
    <div class="frame__footer">
        <div class="frame__subtitle u-text-center"><i>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</i></div>
                        ...
                        <p>
                            ...
                            <Link to="../components/tiles" className="u u-LR">
                                tiles
                            </Link>
                            .
                        </p>
                                ...
                                <div className="frame" style={{ height: '30rem' }}>
                                    ...
                                    <div className="frame__footer">
                                        <div className="form-group input-control">
                                            <input
                                                type="text"
                                                className="form-group-input input-small input-contains-icon"
                                            ...
                                            <button className="btn-primary form-group-btn btn-small">Send</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                            <CodeBlock code={`<div class="frame" style="height: 30rem;">
        ...
        <div class="form-group input-control">
            ...
            <button class="btn-primary form-group-btn btn-small">Send</button>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6"><CodeBlock code={`<div class="frame" style="height: 30rem;">
