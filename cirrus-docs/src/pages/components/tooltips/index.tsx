        ...
        <input type="checkbox"> Tooltips are cool!</label>
                ...
                <section className="padtop" id="directions">
                    <div className="content">
                        ...
                        <div className="divider"></div>
                        <p>Show your tooltips in different directions. The direction class follows a <code>tooltip--[direction]</code> convention, where the direciton can be any of the ones listed below.</p>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                <CodeBlock code={`<div class="button-container">
...
<div class="btn-container">
    <button class="tooltip tooltip--right" data-tooltip="Tooltip Right">Tooltip Right</button>
                ...
                <Pagination prevLink={{ name: 'Toast', link: './toast' }} nextLink={{ name: 'Trees', link: './trees' }} />
            </div>
