...
export const FlexboxUtilsPage: React.FC<any> = (props) => {
    ...
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">c</div>
            ...
            description: (
                <p>
                    ...
                    <code>u-justify-space-between</code> class. This class ensures equal spacing among the elements, but not outside of it.
                </p>
            ),
        },
        {
    ...
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">c</div>
            ...
            description: (
                <p>
                    Sets the item justification to be <code>space-between</code> using the{' '}
                    <code>u-justify-space-between</code> class. This class ensures equal spacing among the elements and outside of it.
                </p>
            ),
        },
        {
    ...
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">c</div>
            ...
            description: (
                <p>
                    Sets the item justification to be <code>space-between</code> using the{' '}
                    <code>u-justify-space-between</code> class. This class ensures equal spacing among the elements, but doubles the space outside of it.
                </p>
            ),
        },
    ];
            ...
            <div>
                ...
                <section className="padtop" id="flex">
                    <div className="content">
                        ...
                        <CodeBlock code={`<div class="u-flex bg-orange-100">
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">a</div>
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">b</div>
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">c</div>
                        ...
                        <div className="space"></div>
                        <CodeBlock code={`<div class="u-inline-flex bg-orange-100">
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">a</div>
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">b</div>
    <div class="bg-orange-200 px-2 py-1 m-1 u-round">c</div>
</div>`} language="htmlbars" />
