...
export const ResponsiveLanding: React.FC<any> = (props) => {
    return (
        <section className="bg-gray-900 min-h-100 w-100 u-justify-center u-items-center">
            <div className="content w-80">
                <div className="u-flex u-flex-column u-items-flex-start u-justify-flex-start u-relative u-flex-row-md u-items-stretch-md">
                    <div className="pt-6 mx-auto w-50-md mx-0-md pb-4-md pr-4-md">
                        <h1 className="headline-4 tracking-tighter text-5xl u-text-center text-white u-text-left-md">
                            The Commerce Platform
                            <br />
                            for <span className="text-indigo-600 font-bold">Creators</span>
                        </h1>
                        <p className="mt-4 mb-8 u-text-center text-gray-600 u-text-left-md">
                            Safely receive gifts from your fans without ever revealing your address or getting a PO box.
                            Show gifts you receive live during your stream.
                        </p>
                        <div className="u-flex u-gap-1 u-flex-column u-justify-center mt-5 u-flex-row-sm mb-8 mt-8-lg">
                            <input
                                type="text"
                                id="input-field-top"
                                className="u-flex-grow-1 w-auto px-3 font-semibold text-gray-300 bg-transparent"
                                placeholder="Enter Username"
                            />
                            <button className="btn--sm btn-link mb-0">Get Started</button>
                        </div>
                    </div>
                    <div className="u-relative u-flex u-items-center u-justify-center w-80 mx-auto mt-8 h-80 w-50-md h-auto-md u-block-md">
                        <img
                            src="https://firebasestorage.googleapis.com/v0/b/onlywish-9d17b.appspot.com/o/common%2Flanding%2Fnewlanding%2FGroup%20100%20(1).jpg?alt=media&token=10d5c8e3-e951-4e5e-8544-ebf1ca2471a0"
                            className="u-left-0 u-z-0 img-cover w-100 h-100 mx-auto u-round-xl mx-0-md w-100-md u-absolute-md u-top-0-md"
                            alt="image"
                        />
                        <div
                            className="u-absolute u-top-0 u-right-0 u-overflow-hidden u-shadow-xl u-right-0-md u-round-lg"
                            style={{
                                height: '8rem',
                                width: '8rem',
                                marginTop: '-2.5rem',
                        ...
                        >
                            <img
                                src="https://firebasestorage.googleapis.com/v0/b/onlywish-9d17b.appspot.com/o/common%2Flanding%2Fprofile.jpeg?alt=media&token=f4e713af-adef-4da3-b9bb-b90b55cb8016"
                                className="u-absolute u-z-0 img-cover w-100 h-100"
                                alt="image"
                            />
                        </div>
                        <div
                            className="u-absolute u-bottom-0 u-z-20 px-4 animated hover-grow u-left-0-md px-0-md"
                            style={{ marginLeft: '-7rem', marginBottom: '-3rem' }}
                        >
                            <a
                                href="https://jointhrone.com/partner-stores"
                                target="_blank"
                                className="u-flex u-items-stretch u-justify-flex-start u-overflow-hidden bg-gray-900 u-shadow-xl u-round-xl p-0"
                            >
                                <div
                                    className="u-relative u-flex u-items-center u-justify-center"
                                    style={{ height: '6rem', width: '7rem' }}
                                >
                                    <img
                                        src="https://cdn.devdojo.com/images/september2021/graphic-color.jpeg"
                                        className="u-absolute u-top-0 u-left-0 u-right-0 u-bottom-0 u-z-0 img-cover w-100 h-100 u-opacity-80"
                                        alt="image"
                                        style={{ objectFit: 'cover', objectPosition: 'center' }}
                                    />
                                </div>
                                <div className="u-flex u-flex-column u-items-flex-start u-justify-center px-4 bg-blue-900 text-gray-400 u-shadow-xl">
                                    <h3 className="text-xl font-bold tracking-tight text-white m-0">Partner Brands</h3>
                                    <p className="text-sm m-0">List your products on Throne</p>
                                </div>
                            </a>
                        </div>
                    </div>
                </div>
                <div className="u-relative u-z-0 u-flex u-items-center u-justify-flex-start py-12 py-0-md">
                    <div className="u-relative u-none u-block-md u-z-10 w-100 max-w-lg px-8 pt-12 pb-12 mx-auto bg-indigo-500 w-50-md mx-0-md mt-0-md pt-2-md pb-4-md u-round-md">
                        <h3 className="text-xl font-bold text-white mx-0 my-1">Built for All Creators</h3>
                        <div className="u-flex u-items-start u-justify-center w-100 u-gap-2 text-white u-justify-flex-start-md">
                            <svg
                            ...
                            >
                                ...
                                >
                                    <path d="M0,172v-172h172v172z" fill="none" />
                                    <g fill="#ffffff">
                                        <path d="M59.125,17.91667c-22.69544,0 -41.20833,18.5129 -41.20833,41.20833v53.75c0,22.69238 18.51225,41.20833 41.20833,41.20833h53.75c22.69303,0 41.20833,-18.51531 41.20833,-41.20833v-53.75c0,-22.69608 -18.51595,-41.20833 -41.20833,-41.20833zM59.125,28.66667h53.75c16.88195,0 30.45833,13.57292 30.45833,30.45833v53.75c0,16.88131 -13.57703,30.45833 -30.45833,30.45833h-53.75c-16.88542,0 -30.45833,-13.57638 -30.45833,-30.45833v-53.75c0,-16.88606 13.57227,-30.45833 30.45833,-30.45833zM121.83333,43c-3.95958,0 -7.16667,3.20708 -7.16667,7.16667c0,3.95958 3.20708,7.16667 7.16667,7.16667c3.95958,0 7.16667,-3.20708 7.16667,-7.16667c0,-3.95958 -3.20708,-7.16667 -7.16667,-7.16667zM86,50.16667c-19.72561,0 -35.83333,16.10772 -35.83333,35.83333c0,19.72561 16.10772,35.83333 35.83333,35.83333c19.72561,0 35.83333,-16.10772 35.83333,-35.83333c0,-19.72561 -16.10772,-35.83333 -35.83333,-35.83333zM86,60.91667c13.91472,0 25.08333,11.16861 25.08333,25.08333c0,13.91472 -11.16861,25.08333 -25.08333,25.08333c-13.91472,0 -25.08333,-11.16861 -25.08333,-25.08333c0,-13.91472 11.16861,-25.08333 25.08333,-25.08333z"></path>
                                    </g>
                                </g>
                            </svg>
                            <svg
